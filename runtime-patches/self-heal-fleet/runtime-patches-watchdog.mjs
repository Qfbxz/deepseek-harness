...
export function apply(ctx, config) {
  try {
    ...
    const checks = [
      ...
      { id: 'p38-driver-agents', file: join(homedir(), '.dsh/profiles/node_modules/@deepseek-ai/dsh-subagent-in-process-driver/lib/index.js'), marker: '/*patch(driver-agents)*/', bad: 'return drivePublishedRun(await parent.ctx.agents.create({', script: 'replay-subagent-driver-agents-access.mjs', extra: [] },
    ];
