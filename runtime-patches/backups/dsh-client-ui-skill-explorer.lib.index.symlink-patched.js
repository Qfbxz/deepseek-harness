...
async function scanSkillRoot(root, level, into) {
	...
	for (const entry of entries) {
		...
		// else-continue above, silently vanishing from the explorer list. Stat the
		// target (follows the link) before the two shape checks.
		...
		},
		{
			...
			handler: async (req, res) => {
				...
				try {
					...
					if (skill === void 0 || skill.path === void 0) {
