window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/boergege/compile/优秀仓库参考/DeepSeek-Harness/packages/client/ui-goal/src/client/GoalBar.module.css.mjs
		const css$1 = ".-WwmOa_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}[data-send-after] .-WwmOa_dock{width:100%;min-width:0;max-width:100%;margin:0;padding:0 10px}[data-send-after] .-WwmOa_dock>*+*{margin-left:8px}.-WwmOa_bar{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-tip);border-radius:12px;align-items:center;gap:10px;min-height:36px;margin:0 auto;padding:4px 5px 4px 12px;display:flex}.-WwmOa_goalGlyph{color:var(--dsw-alias-label-tertiary);flex:none;display:inline-flex}.-WwmOa_label{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:24px}.-WwmOa_objective{min-width:0;color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.-WwmOa_error{min-width:0;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}.-WwmOa_objectiveInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;min-height:26px;color:var(--dsw-alias-label-primary);resize:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:6px;outline:none;flex:1;padding:3px 8px;font-family:inherit;font-size:13px;line-height:20px;overflow-y:auto}.-WwmOa_objectiveInput:focus{border-color:var(--dsw-alias-state-business-primary)}.-WwmOa_objectiveInput::placeholder{color:var(--dsw-alias-label-caption)}.-WwmOa_actions{flex:none;align-items:center;gap:10px;display:flex}.-WwmOa_iconBtn{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.-WwmOa_iconBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.-WwmOa_iconBtn:disabled{opacity:.4;cursor:default}";
		...
		var GoalBar_module_css_default = {
			...
			"dock": "-WwmOa_dock",
			"error": "-WwmOa_error",
			"iconBtn": "-WwmOa_iconBtn",
			"objective": "-WwmOa_objective",
			"actions": "-WwmOa_actions",
			"objectiveInput": "-WwmOa_objectiveInput",
			"goalGlyph": "-WwmOa_goalGlyph"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/boergege/compile/优秀仓库参考/DeepSeek-Harness/packages/client/ui-goal/src/client/GoalCommandInputView.module.css.mjs
		const css = "._60A_eW_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}._60A_eW_stack{flex-direction:column;align-items:flex-end;min-width:0;max-width:min(525px,82%);display:flex}._60A_eW_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code);white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
